...
int main(void) {
  ...
  while (1) {
    ...
    TIM2 -> CCR2 = (65535 - 001 * 255);
    TIM2 -> CCR3 = (65535 - 255 * 255);
    TIM2 -> CCR4 = (65535 - 255 * 255);
...
void HAL_UART_RxCpltCallback(UART_HandleTypeDef * huart) {
  if (huart == & huart1) // Make sure the callback is for UART1
  {
    if (recvd_data == '\r') { //when enter is pressed go to this condition
      ...
      if (stringcmp(data_buffer, "RGB_") == 0) {
